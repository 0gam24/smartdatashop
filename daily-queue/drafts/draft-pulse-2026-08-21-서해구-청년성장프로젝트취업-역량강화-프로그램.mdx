---
title: "서해구 청년성장프로젝트(취업 역량강화 프로그램)"
publishedAt: "2026-08-07T06:57:57.000Z"
category: policy
tldr: " [검수 후 보강] [검수 후]"
sources:
  - name: "정부24 채용·복지일자리 — 서해구 청년성장프로젝트(취업 역량강화 프로그램)"
    date: "2026-08-21"
    url: "/portal/service/serviceInfo/356100000006"
...
본 글은 `scripts/draft-pulse-from-rss.mjs` 가 `정부24 채용·복지일자리` 의 RSS 1차 출처에서
...
원문 링크: [서해구 청년성장프로젝트(취업 역량강화 프로그램)](/portal/service/serviceInfo/356100000006)
