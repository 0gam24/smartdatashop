---
title: "검색 친화적인 URL 구축하기"
category: "검색엔진 최적화 고급"
slug: "seo-advanced-url"
source: "https://searchadvisor.naver.com/guide/seo-advanced-url"
updated: "2021-03-24"
---
...
- *https://www.mysite.com/1001125/1079/action.do?tab=guide&method=selectPage&menu\_id=EMWPCnslWebInqL* (X)
...
[URL](https://terms.naver.com/entry.nhn?docId=3571733&cid=59088&categoryId=59096)은 네트워크 상에서 자원이 어디 있는지를 알려주기 위한 규약이며, 통상 웹 페이지를 찾기 위한 주소를 지칭합니다.

`https://search.naver.com/search.naver?query=naver&page=2&where=web#section`

- https : 프로토콜
    - 보안이 강화된 [https 프로토콜](https://terms.naver.com/entry.nhn?docId=3436086&cid=42346&categoryId=42346)을 사용을 권장합니다.
...
- section : 부분 식별자 (fragment)
    - 동일한 웹 페이지 내의 특정 부분을 지칭합니다. 예를 들어 위키피디어의 K-pop 문서의 경우 "[역사](https://ko.wikipedia.org/wiki/K-pop#%EC%97%AD%EC%82%AC)"라는 세부 주제로 바로 지정할 수 있습니다.

### 검색 친화적인 URL

- 사용자에게 친숙한 최상위 도메인을 사용해야 합니다. 예를 들면 아래와 같은 도메인입니다.
    - `.com, .net, .co.kr, .kr, .io`
- 웹 호스팅 서비스에서 기본적으로 제공하는 도메인보다는 사이트 성격에 맞는 고유한 도메인을 사용하세요.
...
- 부분 식별자(fragment)는 검색엔진이 해석하지 않기 때문에 콘텐츠의 성격이 다른 페이지는 독립된 URL로 구축합니다.
...
- 해시뱅(#!) 형식의 URL 도 검색엔진이 해석하지 않습니다.
    - *https://www.mysite.com/path/to/#!/some-ajax-state* (X)
        - 검색엔진은 *https://www.mysite.com/path/to/* 까지만 인식
...
- 세션, 쿠키 등에 따라서 링크 URL이 동적으로 변경되는 경우
- 특정 페이지를 직접 접근할 때와 다른 페이지를 경유해서 접근할 때 링크 URL이 변경되는 경우
