...
**[본문 분량 + 해설 흐름]** ★ SEO + AdSense 신뢰 (2026-05-28 운영자 피드백 "짧지 않아?")
- ☐ **본문 1,800~2,800자** 의무 — 종전 권장(1,500~2,500자)에서 하한 +300자 상향
- ☐ **표 직후 해설 단락 필수** — 표가 압축 정보를 제공한 후 1-2개 단락으로 *의미·맥락·분석* 풀이. 표만 나열 금지
- ☐ **§배경·원인 분석 섹션 1개+** — "왜 이런 결과인가" / "이전과 무엇이 다른가" 정성 해설 (§1-1 / §1-2 류 보조 섹션 활용)
- ☐ **§시사점·큰 그림 섹션 1개** — FAQ 직전 위치, 본 발표가 더 큰 정책 맥락에서 어떤 의미인지 풀이
- ☐ **독자 체크리스트 5단계+** (종전 3단계 권장 → 5단계 상향) — HowTo LD 자동 발행 + 실용성 ↑
- ☐ **국제 비교 또는 시계열 비교 1단락 권장** — 한국 단독 수치만 나열 X, *상대성* 추가

자수 자체 검증: 본문 작성 후 frontmatter 제외 글자수 카운트 (1,800자 미만 시 §배경 또는 §시사점 추가 보강)
