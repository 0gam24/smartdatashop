...
> **출처(Source):** https://developers.google.com/search/docs/appearance/flexible-sampling?hl=ko
...
Google에서 페이월 콘텐츠와 [클로킹](https://developers.google.com/search/docs/advanced/guidelines/cloaking?hl=ko) 행위를 구분할 수 있도록 페이월 콘텐츠를 구조화된 데이터에 포함합니다. 클로킹이란 Googlebot에 제공되는 콘텐츠와 사용자에게 제공되는 콘텐츠가 다른 경우를 말합니다.
